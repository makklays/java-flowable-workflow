...
import {
    faFileInvoice, faPlus, faClock, faWallet, faCreditCard
        ...
        <div>
            <div className="row">
                <div className="col-md-12">
                    <h3><FontAwesomeIcon icon={faCreditCard} className="me-2" /> {t('payments')}</h3>
                    <p>Список возможных банковских платежей. {role === 'ADMIN' ? 'Все активные платижы' : ''}</p>
                </div>
            </div>
