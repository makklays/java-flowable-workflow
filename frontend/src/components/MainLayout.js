    ...
    const AdminSidebar = () => (
        <aside style={{
            ...
            <Nav className="flex-column p-3 gap-1">
                <Nav.Link as={NavLink} to={`/${lng}/`}  style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                ...
                <Nav.Link as={NavLink} to={`/${lng}/contacts`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faAddressBook} className="me-3 text-secondary" /> {t('contacts')}
                </Nav.Link>
                <Nav.Link as={NavLink} to={`/${lng}/activities`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faHeartPulse} className="me-3 text-secondary" /> {t('activities')}
                </Nav.Link>
                <Nav.Link as={NavLink} to={`/${lng}/clients`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faUsers} className="me-3 text-secondary" /> {t('clients')}
                </Nav.Link>
                <Nav.Link as={NavLink} to={`/${lng}/deals`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                ...
                <Nav.Link as={NavLink} to={`/${lng}/trading`} style={isTradingActive ? { backgroundColor: '#e9ecef', fontWeight: 'bold', color: '#000' } : {}} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faChartLine} className="me-3 text-secondary" /> {t('trading')}
                </Nav.Link>
                <Nav.Link as={NavLink} to={`/${lng}/backtest`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faFlask} className="me-3 text-secondary" /> {t('backtest')}
                </Nav.Link>
                <Nav.Link as={NavLink} to={`/${lng}/grafics`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faDisplay} className="me-3 text-secondary" /> {t('grafics')}
                </Nav.Link>
                <Nav.Link as={NavLink} to={`/${lng}/symbols`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faCoins} className="me-3 text-secondary" /> {t('symbols')}
                </Nav.Link>
                <Nav.Link as={NavLink} to={`/${lng}/candles`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                ...
                <Nav.Link as={NavLink} to={`/${lng}/tasks`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faTasks} className="me-3 text-secondary" /> {t('tasks')}
                </Nav.Link>
                <Nav.Link as={NavLink} to={`/${lng}/history`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faHistory} className="me-3 text-secondary" /> {t('history')}
                </Nav.Link>
                <Nav.Link as={NavLink} to={`/${lng}/calendar`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                ...
                <Nav.Link as={NavLink} to={`/${lng}/departments`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faSitemap} className="me-3 text-secondary" /> {t('departments')}
                </Nav.Link>
                <Nav.Link as={NavLink} to={`/${lng}/positions`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faBriefcase} className="me-3 text-secondary" /> {t('positions')}
                </Nav.Link>
                <Nav.Link as={NavLink} to={`/${lng}/roles`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faUserShield} className="me-3 text-secondary" /> {t('roles')}
                </Nav.Link>
                <Nav.Link as={NavLink} to={`/${lng}/users`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faUserGroup} className="me-3 text-secondary" /> {t('users')}
                </Nav.Link>

                <hr className="my-2 opacity-25" />

                <Nav.Link as={NavLink} to={`/${lng}/learn`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faLaptopCode} className="me-3 text-secondary" /> {t('learn') + ' counter' }
                </Nav.Link>
                <Nav.Link as={NavLink} to={`/${lng}/learn2`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faLaptopCode} className="me-3 text-secondary" /> {t('learn') + ' redux' }
                </Nav.Link>

                <hr className="my-auto opacity-25" />

                <Nav.Link as={NavLink} to={`/${lng}/settings`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark mt-3">
                    <FontAwesomeIcon icon={faGear} className="me-3 text-secondary" /> {t('settings')}
                </Nav.Link>
                <Nav.Link as={NavLink} to={`/${lng}/about`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
    ...
    const BankSidebar = () => (
        <aside style={{ width: '260px', minWidth: '260px', backgroundColor: '#e3f2fd', borderRight: '1px solid #dee2e6', overflowY: 'auto' }}>
            <Nav className="flex-column p-3 gap-1 bank">
                ...
                <Nav.Link as={NavLink} to={`/${lng}/bank/accounts`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faWallet} className="me-3 text-primary" /> {t('my_accounts')}
                </Nav.Link>
                <Nav.Link as={NavLink} to={`/${lng}/bank/applications`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                ...
                <Nav.Link as={NavLink} to={`/${lng}/bank/transfers`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faRightLeft} className="me-3 text-primary" /> {t('perevodu')}
                </Nav.Link>
                <Nav.Link as={NavLink} to={`/${lng}/bank/payments`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faCreditCard} className="me-3 text-primary" /> {t('payments')}
                </Nav.Link>
                <Nav.Link as={NavLink} to={`/${lng}/bank/credits`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                ...
                <Nav.Link as={NavLink} to={`/${lng}/bank/investments`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faChartPie} className="me-3 text-primary" /> {t('investments')}
                </Nav.Link>
                <Nav.Link as={NavLink} to={`/${lng}/bank/forex`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faCoins} className="me-3 text-primary" /> {t('forex')}
                </Nav.Link>
                <Nav.Link as={NavLink} to={`/${lng}/bank/stock-market`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
                    <FontAwesomeIcon icon={faArrowTrendUp} className="me-3 text-primary" /> {t('stock_market')}
                </Nav.Link>
                <Nav.Link as={NavLink} to={`/${lng}/bank/advisor`} style={activeLinkStyle} className="rounded px-3 py-2 text-dark">
